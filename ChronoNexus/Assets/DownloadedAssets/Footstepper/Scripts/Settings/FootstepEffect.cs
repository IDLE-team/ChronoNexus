	...
	public class FootstepEffect
	{
		...
		public virtual AudioClip GetClip(FootstepType type, string customName)
		{
			if(FootstepType.Walk == type)
			{
				...
				{
					return this.walkAudioClips[Random.Range(0, this.walkAudioClips.Count)];
				}
				else if(this.runAudioClips.Count > 0)
				{
					return this.runAudioClips[Random.Range(0, this.runAudioClips.Count)];
				}
				else if(this.sprintAudioClips.Count > 0)
				{
					return this.sprintAudioClips[Random.Range(0, this.sprintAudioClips.Count)];
				}
			}
			...
			else if(FootstepType.Jump == type)
			{
				...
				{
					return this.jumpAudioClips[Random.Range(0, this.jumpAudioClips.Count)];
				}
			}
			else if(FootstepType.Land == type)
			{
				...
				{
					return this.landAudioClips[Random.Range(0, this.landAudioClips.Count)];
				}
			}
		...
		public virtual FootstepPrefab GetPrefab(FootstepType type, string customName)
		{
			if(FootstepType.Walk == type)
			{
				...
				{
					return this.walkPrefabs[Random.Range(0, this.walkPrefabs.Count)];
				}
				else if(this.runPrefabs.Count > 0)
				{
					return this.runPrefabs[Random.Range(0, this.runPrefabs.Count)];
				}
				else if(this.sprintPrefabs.Count > 0)
				{
					return this.sprintPrefabs[Random.Range(0, this.sprintPrefabs.Count)];
				}
			}
			else if(FootstepType.Run == type)
			{
			...
			else if(FootstepType.Jump == type)
			{
				...
				{
					return this.jumpPrefabs[Random.Range(0, this.jumpPrefabs.Count)];
				}
			}
			else if(FootstepType.Land == type)
			{
				...
				{
					return this.landPrefabs[Random.Range(0, this.landPrefabs.Count)];
				}
			}
			else if(FootstepType.Custom == type)
			{
