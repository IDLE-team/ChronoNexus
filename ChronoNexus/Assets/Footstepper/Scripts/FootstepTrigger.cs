...
namespace GamingIsLove.Footsteps
{
	...
	public class FootstepTrigger : MonoBehaviour
	{
		...
		[Tooltip("The index of the foot this footstep trigger will be used for.\n" +
			"This is used by index prefabs of footstep effects to match a prefab to a foot.")]
		...
		protected virtual void OnTriggerEnter(Collider other)
		{
				...
				this.CheckLayer(other.gameObject))
			{
				...
				if(footstepSource != null)
				{
					...
					this.footstepper.PlayFootstep(this.transform, this.footIndex, footstepSource, this.raycastPosition);
				}
			}
		}
