...
namespace GamingIsLove.Footsteps
{
	...
	public class RaycastResult
	{
		...
		public static RaycastResult Raycast3D(Vector3 position, float distance, LayerMask layerMask)
		{
			...
			{
				RaycastResult result = new RaycastResult(hitInfo.transform, hitInfo.point, hitInfo.normal);
				result.triangleIndex = hitInfo.triangleIndex;
				result.textureCoord = hitInfo.textureCoord;
				return result;
			}
			return null;
		}
